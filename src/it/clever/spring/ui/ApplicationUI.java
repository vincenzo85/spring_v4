...
//	public WSData puntamentiWsSos;
	...
	// sto sfruttando il cotensto per fare l'autenticazione... 
	public void authenticateUser() throws AuthenticationException {
		
		System.out.println("\nAutenticazione utente in corso..");
		// qui sto prendendo dal contesto ... quel bean...
		// nelle applicazioni web non ci sarà mai getBean 
		// ne faccio il cast .... perchè potrebbe essere di qualsiasi tipo....
		// il main è fuori dal contesto...
		// cosa vuol dire fare parte del contesto di spirng .... ?
		// mi permette di avere un atowired...
		// io sono una classe pippo... io sono parte del contesto... 
		// posso ricevere una iniezione di dipendenza...
		// devo avere l'annotazione @service @component... 
